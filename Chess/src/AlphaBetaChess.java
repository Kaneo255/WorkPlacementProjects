...
public class AlphaBetaChess {
    ...
    static int humanAsWhite =-1; //Human is white = 1 Human is black = 0
    ...
    public static void main(String[] args) {
        ...
        humanAsWhite = JOptionPane.showOptionDialog(null, "Who will be the white piece?", "ABC Options", JOptionPane.YES_NO_OPTION, 
