 ...
 * @author x12404332
 */
public class Kinesthetic extends javax.swing.JFrame {

    /**
     * Creates new form Kinesthetic
     */
    public Kinesthetic() {
        initComponents();
    ...
    private void initComponents() {
        ...
        pictureLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/computingsupport/Kinesthetic Learner.png"))); // NOI18N
        pictureLbl.setText("jLabel1");
        pictureLbl.setBounds(20, 170, 260, 220);
        ...
        HeadingLbl.setText("Kinesthetic Learner");
        HeadingLbl.setBounds(100, 130, 180, 25);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kinesthetic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kinesthetic().setVisible(true);
            }
        });
    }
