 ...
 */
public class LearnLocation extends javax.swing.JFrame {

    /**
     * Creates new form LearnLocation
     */
    public LearnLocation() {
        initComponents();
    ...
    private void initComponents() {
        ...
        LectureTimesLbl.setText("Class Locations");
        LectureTimesLbl.setBounds(110, 120, 180, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LearnLocation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LearnLocation().setVisible(true);
            }
        });
    }
